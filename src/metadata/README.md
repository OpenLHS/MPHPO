 ...
 * [MPHPO.yml](MPHPO.yml)
     * Determines how your purl.obolibrary.org/obo/MPHPO/ redirects will be handled
     ...
     * Paste in the contents of [MPHPO.yml](MPHPO.yml)
 ...
 * [MPHPO.md](MPHPO.md)
     ...
     * Paste in the contents of [MPHPO.md](MPHPO.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
